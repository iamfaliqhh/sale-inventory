                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="product_weight" name="product_weight" required value="{{ old('product_weight') }}" min="0" step="0.01">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_purity" required value="{{ old('product_purity', 916) }}" min="1" max="1000">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
